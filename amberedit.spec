...
- add/modify some default keys (see CHANGELOG.md)
- add man page
...
* Fri Sep 18 2026 Yegor Gluhov <git@jegor.net> - 0.8.8-1
- compose_add_pid
- compose_add_kludge
...
* Sat Sep 12 2026 Yegor Gluhov <git@jegor.net> - 0.8.2-1
...
* Wed Sep 09 2026 Yegor Gluhov <git@jegor.net> - 0.8.1-1
- FSP-1030 kludges support

* Wed Sep 09 2026 Yegor Gluhov <git@jegor.net> - 0.8-1
- truecolor themes
...
* Tue Sep 08 2026 Yegor Gluhov <git@jegor.net> - 0.7.3-1
- fix editor soft-wrapping (again)

* Mon Sep 07 2026 Yegor Gluhov <git@jegor.net> - 0.7.2-1
- fix double ^A breaking kludges parsing

* Mon Sep 07 2026 Yegor Gluhov <git@jegor.net> - 0.7.1-1
- fix editor soft-wrapping
- relayout reader on window height change

* Sat Sep 05 2026 Yegor Gluhov <git@jegor.net> - 0.7-1
- add Help dialog (F1)
- add map_path

* Fri Sep 04 2026 Yegor Gluhov <git@jegor.net> - 0.6.6-1
- ignore malformed CHRS kludge
...
- fix zipped nodelist issue

* Sun Aug 30 2026 Yegor Gluhov <git@jegor.net> - 0.6.2-1
- compose_fts1_field_limits
- minor fixes

* Sun Aug 30 2026 Yegor Gluhov <git@jegor.net> - 0.6.1-1
- @file: lists for origin, tearline and twits

* Sun Aug 30 2026 Yegor Gluhov <git@jegor.net> - 0.6-1
- Read echoareadefaults and set from fidoconfig
- arealist_first_unread config option
- quote_unwrap config option
- reader_edge replaces reader_edge_exit (breaking change)
- timezone in template

* Sat Aug 29 2026 Yegor Gluhov <git@jegor.net> - 0.5.3-1
- Area sidebar tree

* Sat Aug 29 2026 Yegor Gluhov <git@jegor.net> - 0.5.2-1
- Reply in the charset of the message answered
- Area list context menu

* Fri Aug 28 2026 Yegor Gluhov <git@jegor.net> - 0.5.1-1
- Toggle unread areas
